...
func SeedToys() {
	toys := []models.Toy{
		...
		{ReleaseDate: time.Date(1989, time.May, 22, 0, 0, 0, 0, time.UTC), Price: 75, ProductType: "Michelangelo Action Figure", Theme: "Teenage Mutant Ninja Turtles", Count: 12, Available: true, UserId: 1, Company: "PlaymatesToys", Rating: 3.5},
		...
		{ReleaseDate: time.Date(1988, time.October, 12, 0, 0, 0, 0, time.UTC), Price: 20, ProductType: "Leonardo Action Figure", Theme: "Teenage Mutant Ninja Turtles", Count: 25, Available: true, UserId: 1, Company: "PlaymatesToys", Rating: 4.5},
		{ReleaseDate: time.Date(1989, time.March, 5, 0, 0, 0, 0, time.UTC), Price: 25, ProductType: "Donatello Action Figure", Theme: "Teenage Mutant Ninja Turtles", Count: 18, Available: true, UserId: 2, Company: "PlaymatesToys", Rating: 4.7},
		{ReleaseDate: time.Date(1990, time.June, 21, 0, 0, 0, 0, time.UTC), Price: 30, ProductType: "Shredder Action Figure", Theme: "Teenage Mutant Ninja Turtles", Count: 15, Available: true, UserId: 3, Company: "PlaymatesToys", Rating: 4.6},
		{ReleaseDate: time.Date(1991, time.April, 10, 0, 0, 0, 0, time.UTC), Price: 35, ProductType: "Splinter Action Figure", Theme: "Teenage Mutant Ninja Turtles", Count: 20, Available: true, UserId: 1, Company: "PlaymatesToys", Rating: 4.8},
		{ReleaseDate: time.Date(1992, time.November, 7, 0, 0, 0, 0, time.UTC), Price: 40, ProductType: "Raphael Action Figure", Theme: "Teenage Mutant Ninja Turtles", Count: 22, Available: true, UserId: 2, Company: "PlaymatesToys", Rating: 4.7},
		{ReleaseDate: time.Date(1995, time.March, 15, 0, 0, 0, 0, time.UTC), Price: 60, ProductType: "Bebop and Rocksteady Set", Theme: "Teenage Mutant Ninja Turtles", Count: 10, Available: true, UserId: 3, Company: "PlaymatesToys", Rating: 4.5},
		{ReleaseDate: time.Date(1996, time.August, 23, 0, 0, 0, 0, time.UTC), Price: 50, ProductType: "Turtle Van Playset", Theme: "Teenage Mutant Ninja Turtles", Count: 8, Available: true, UserId: 1, Company: "PlaymatesToys", Rating: 4.9},
		{ReleaseDate: time.Date(1997, time.December, 9, 0, 0, 0, 0, time.UTC), Price: 70, ProductType: "TMNT Sewer Playset", Theme: "Teenage Mutant Ninja Turtles", Count: 12, Available: true, UserId: 2, Company: "PlaymatesToys", Rating: 4.6},
		{ReleaseDate: time.Date(1999, time.July, 4, 0, 0, 0, 0, time.UTC), Price: 18, ProductType: "Teenage Mutant Ninja Turtles Pizza Thrower", Theme: "Teenage Mutant Ninja Turtles", Count: 15, Available: true, UserId: 3, Company: "PlaymatesToys", Rating: 4.3},
		{ReleaseDate: time.Date(2001, time.February, 20, 0, 0, 0, 0, time.UTC), Price: 40, ProductType: "TMNT Secret Sewer Lair", Theme: "Teenage Mutant Ninja Turtles", Count: 25, Available: true, UserId: 1, Company: "PlaymatesToys", Rating: 4.7},
		{ReleaseDate: time.Date(2003, time.July, 15, 0, 0, 0, 0, time.UTC), Price: 45, ProductType: "TMNT Battle Shells Set", Theme: "Teenage Mutant Ninja Turtles", Count: 18, Available: true, UserId: 2, Company: "PlaymatesToys", Rating: 4.6},
		{ReleaseDate: time.Date(2005, time.May, 10, 0, 0, 0, 0, time.UTC), Price: 90, ProductType: "TMNT Turtle Blimp", Theme: "Teenage Mutant Ninja Turtles", Count: 8, Available: true, UserId: 3, Company: "PlaymatesToys", Rating: 4.8},
		{ReleaseDate: time.Date(2007, time.August, 23, 0, 0, 0, 0, time.UTC), Price: 25, ProductType: "TMNT Foot Soldier", Theme: "Teenage Mutant Ninja Turtles", Count: 20, Available: true, UserId: 1, Company: "PlaymatesToys", Rating: 4.4},
		{ReleaseDate: time.Date(2011, time.March, 30, 0, 0, 0, 0, time.UTC), Price: 55, ProductType: "TMNT Raph's Shellraiser", Theme: "Teenage Mutant Ninja Turtles", Count: 10, Available: true, UserId: 2, Company: "PlaymatesToys", Rating: 4.7},
		{ReleaseDate: time.Date(2013, time.June, 5, 0, 0, 0, 0, time.UTC), Price: 35, ProductType: "TMNT The Technodrome", Theme: "Teenage Mutant Ninja Turtles", Count: 18, Available: true, UserId: 3, Company: "PlaymatesToys", Rating: 4.6},
		{ReleaseDate: time.Date(2015, time.August, 19, 0, 0, 0, 0, time.UTC), Price: 60, ProductType: "TMNT Battle Shells Leonardo", Theme: "Teenage Mutant Ninja Turtles", Count: 12, Available: true, UserId: 1, Company: "PlaymatesToys", Rating: 4.8},
		{ReleaseDate: time.Date(2017, time.November, 11, 0, 0, 0, 0, time.UTC), Price: 45, ProductType: "TMNT Ultimate Shellraiser", Theme: "Teenage Mutant Ninja Turtles", Count: 9, Available: true, UserId: 2, Company: "PlaymatesToys", Rating: 4.7},
		{ReleaseDate: time.Date(2019, time.May, 13, 0, 0, 0, 0, time.UTC), Price: 50, ProductType: "TMNT Sewer Playset", Theme: "Teenage Mutant Ninja Turtles", Count: 8, Available: true, UserId: 3, Company: "PlaymatesToys", Rating: 4.9},
		{ReleaseDate: time.Date(2020, time.January, 8, 0, 0, 0, 0, time.UTC), Price: 30, ProductType: "TMNT Bebop and Rocksteady", Theme: "Teenage Mutant Ninja Turtles", Count: 15, Available: true, UserId: 1, Company: "PlaymatesToys", Rating: 4.6},
